...
export function EVFleet() {
  ...
  return (
    <>
      <head>
        <title>EV Fleet | Czar PCO</title>
        <meta
          name="description"
          content="Discover our collection of PCO-ready Full-Electric vehicles. We offer the latest models of the Electric Vehicles for the PCO drivers."
        />
      </head>
      <div className="Home evFleet">
            ...
            <div className="benefit">
              ...
              <div className="benefitText">
                ...
                <span className="benefitDescription">
                  ...
                  ULEZ fees. Drivers can save up to £150 per week from
            ...
            <div className="benefit">
              ...
              <div className="benefitText">
                ...
                <span className="benefitDescription">
                  ...
                  residential electric rates that cost only a few cents per
                  hour. Moreover, on average, it will cost drivers approximately
                  £12-£15 to fully charge their electric vehicle.
                </span>
              </div>
            </div>
          </div>
            ...
            <div className="benefit">
              ...
              <div className="benefitText">
                ...
                <span className="benefitDescription">
                  ...
                  in towns and cities and protecting the environment.
                </span>
              </div>
            </div>
            <div className="benefit">
              ...
              <div className="benefitText">
                ...
                <span className="benefitDescription">
                  ...
                  the energy stored in gasoline into driving power, BEVs are
                  able to convert over 77% of the electrical energy from the
                  grid to power the wheels.
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="CTA_row notBanner">
          ...
          <div className="fullWidthCTA">
            ...
            <Link to="/czar/faq" className="secondaryBtn scrollDown">
              Visit our FAQ page
              <LogoBG />
            </Link>
          </div>
