...
export function Fleet() {
  ...
  return (
    <>
      <head>
        <title>Fleet | Czar PCO</title>
        <meta
          name="description"
          content="Discover our vast variety of PCO-ready vehicles. Choose a car from our diverse fleet of vehicles which suits you the most."
        />
      </head>
        ...
        <div className="hero evHeading notBanner">
          <div className="heroTextArea">
            <div className="heroText">
              <h1>Our Fleet</h1>
              <span>
                Choose a car from our broad range of vehicles which suits you
                the most. Contact us anytime for more information.
              </span>
            </div>
            <img
              src={trustpilotMini}
